"""motherducker URL Configuration
...
from payloads.viewset import ScriptViewSet, LogViewSet, ConnectionViewSet, PayloadViewSet
...
urlpatterns = [
    ...
    path('payloads/', include('payloads.urls')),
